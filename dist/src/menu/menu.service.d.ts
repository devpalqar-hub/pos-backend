...
export declare class MenuService {
    ...
    private resolveSort;
    findAll(actor: User, restaurantId: string, page?: number, limit?: number, search?: string, sortBy?: string): Promise<{
        data: {
            id: string;
            name: string;
            description: string | null;
    ...
    findByCategory(actor: User, restaurantId: string, categoryId: string, page?: number, limit?: number, search?: string, sortBy?: string): Promise<{
        data: {
            id: string;
            name: string;
            description: string | null;
