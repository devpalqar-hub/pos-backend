...
const table_groups_controller_1 = require("./table-groups.controller");
let TablesModule = class TablesModule {
};
exports.TablesModule = TablesModule;
exports.TablesModule = TablesModule = __decorate([
    (0, common_1.Module)({
        controllers: [table_groups_controller_1.TableGroupsController, tables_controller_1.TablesController],
